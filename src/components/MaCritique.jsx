            ...
            <form id="critiqueForm" onSubmit={(event) => props.creerCritique(event, props.id)}>
                <div className="card border-3">
                    <div className="row text-start m-4">
                        <div className="col col-11">
                            ...
                            <div className="pb-4">
                                ...
                                <input type="text" className="form-control" name="temperament"/>
                            </div>
                            <div className="pb-4">
                                <label className="form-label">Beauté:</label>
                                <input type="text" className="form-control" name="beaute"/>
                            </div>
                            <div className="pb-4">
                                <label className="form-label">Utilisation:</label>
                                <input type="text" className="form-control" name="utilisation"/>
                            </div>
                        </div>
                    ...
                    <div className="btn-wrapper text-center d-flex justify-content-end ">
                        <button type="submit" className={"btn btn-success m-3"}>Ajouter</button>
                    </div>
                </div>
            </form>
        </div>
