                                    ...
                                    <div className="row">
                                        <div className="col-xl-4 col-xxl-3 col-md-12 col-lg-6 align-content-center">
                                            <div className="ajouterPhoto rounded-3">
                                                <img src={props.srcImage} className="card-img " alt="image selectionnée par l'utilisateur"/>
                                            </div>
                                        ...
                                        <div className="col mx-5 text-start">
                                            <div className="pb-4">
                                                ...
                                                <select className="form-select" disabled><option defaultValue={props.categorie}>{props.categorie}</option></select>
                                            </div>
                                            <div className="pb-4">
